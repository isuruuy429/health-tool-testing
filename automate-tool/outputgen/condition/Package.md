...
| Profile URL          |[http://hl7.org.nz/fhir/StructureDefinition/NzCondition](http://hl7.org.nz/fhir/StructureDefinition/NzCondition)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/nzbase.condition ConditionAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type Condition r4:Condition|<Other_Condition_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org.nz/fhir/StructureDefinition/NzCondition", "new_profile_url"]`
