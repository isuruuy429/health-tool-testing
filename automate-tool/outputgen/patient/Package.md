...
| Profile URL          |[http://hl7.org.nz/fhir/StructureDefinition/NzPatient](http://hl7.org.nz/fhir/StructureDefinition/NzPatient)|
...
Pull the template from central
    ...
    ` bal new -t healthcare/nzbase.patient PatientAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type Patient r4:Patient|<Other_Patient_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org.nz/fhir/StructureDefinition/NzPatient", "new_profile_url"]`
